...
local Section2 = Tab2:CreateSection("出租车")
...
Section2:CreateButton({
    ...
    Callback = function()
        ...
        if character and character:FindFirstChild("HumanoidRootPart") and target then
            ...
            local targetCFrame = target.CFrame * CFrame.new(0, 3, 0)
            ...
            task.spawn(function()
                for i = 1, stepCount do
                    hrp.CFrame = hrp.CFrame:Lerp(targetCFrame, i / stepCount)
                    task.wait(waitTime) 
                end
