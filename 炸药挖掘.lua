        ...
        if state then
            ...
            if player.Character then
                ...
                if humanoidRootPart then
                    ...
                    ReplicatedStorage.Tools.PlaceExplosive:FireServer(position)
                    
                    -- while state and task.wait(0.5) do
                    --     if character and humanoidRootPart then
                    --         local newPosition = humanoidRootPart.Position - Vector3.new(0, 3, 0)
                    --         ReplicatedStorage.Tools.PlaceExplosive:FireServer(newPosition)
                    --     else
                    --         break
                    --     end
                    -- end
