...
local Toggle = Tab:Toggle({
    ...
    Callback = function(state)
        if state then
            ...
            spawn(function()
                while autoSkill do
                    game:GetService("ReplicatedStorage").Events.SkillEvent:FireServer("Skill1")
                    wait(1)
                    game:GetService("ReplicatedStorage").Events.SkillEvent:FireServer("Skill2")
                    wait(1)
                    game:GetService("ReplicatedStorage").Events.SkillEvent:FireServer("Skill3")
                    wait(1)
                    game:GetService("ReplicatedStorage").Events.SkillEvent:FireServer("Skill4")
                    wait(1)
                end
            end)
        else
