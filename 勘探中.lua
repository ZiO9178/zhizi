...
local Button = Tab:Button({
    ...
    Locked = false,
    Callback = function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-4.306746959686279, 24.999996185302734, 56.75730514526367)
    end
})
...
local Button = Tab:Button({
    ...
    Locked = false,
    Callback = function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(40.55136489868164, 25, 64.65571594238281)
    end
})
...
local Button = Tab:Button({
    ...
    Locked = false,
    Callback = function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(23.884584426879883, 25, 109.92393493652344)
    end
})