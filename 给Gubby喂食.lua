...
local Toggle = Tab:Toggle({
    ...
    Callback = function(state)
        if state then
            ...
            task.spawn(function()
                while getgenv().AutoClick and task.wait(0.1) do
                    local part = workspace.Plots.Plot6.Objects.Pump.Model.ButtonModel.ClickPart
